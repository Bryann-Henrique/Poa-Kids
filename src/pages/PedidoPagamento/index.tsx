...
import phoneImg from '../../assets/img/icons/form/telefone.svg';
import mailImg from '../../assets/img/icons/form/mail.svg';
import idImg from '../../assets/img/icons/form/id.svg';
import creditCardImg from '../../assets/img/icons/form/credit-card.svg';
import calendarImg from '../../assets/img/icons/form/calendario.svg';
import lockImg from '../../assets/img/icons/form/cadeado.svg';
import { Link } from 'react-router-dom';

const PedidoPagamento: React.FC = () => {
    const [aceitaTermos, setAceitaTermos] = useState(false);
    const [disabledCheck, setDisabledCheck] = useState(true)
    const [showFormFatura, setShowFormFatura] = useState(false)

    const LiberaCheck = (e: any) => {
    ...
    return (
        <>
            ...
            <form action="" method="post" className="container">
                <div className="my-5">
                    <h1 className="titulo_simples">CONFIRMAR PAGAMENTO</h1>
                </div>
                ...
                <div id="pessoal" className="mt-5">
                        ...
                        <div className="d-flex flex-column flex-wrap flex-lg-row justify-content-between">
                            ...
                            <div className="input_icon_custom form-group col-12 col-lg-2 p-0">
                                <div className="input-group">
                                    <div className="input-group-prepend">
                                        <span className="input-group-text">
                                            <img src={calendarImg} alt="Nascimento" />
                                        </span>
                                    </div>
                    ...
                    <div id="dados_pagamento" className="mb-3">
                        <h2 className="titulo_simples_2">
                            DADOS DE PAGAMENTO
                        </h2>
                        ...
                        <div className="d-flex flex-column flex-lg-row flex-wrap justify-content-between">
                            ...
                            <div className="input_icon_custom form-group col-12 col-lg-3 p-0">
                                <div className="input-group">
                                    <div className="input-group-prepend">
                                        <span className="input-group-text">
                                            <img src={calendarImg} alt="Validade" />
                                        </span>
                                    </div>
                    ...
                    <div id="endereco_fatura" className="mb-3">
                        <h2 className="titulo_simples_2">
                        ...
                        <div className="d-flex flex-column flex-lg-row flex-wrap justify-content-between">
                            ...
                            <div className="form-group col-12 col-lg-3 p-0">
                                <select id="fatura_uf" className="select_custom form-control" style={{height: '48px'}}>
                    ...
                    <div id="endereco_recebimento" className="mb-3">
                        <h2 className="titulo_simples_2">
                        ...
                        <div id="div_endereço_recebimento" className={`collapse ${showFormFatura && 'show'} mt-4 pt-4`} style={{borderTop: '1px solid #ccc'}}>
                            <div className="d-flex flex-column flex-lg-row flex-wrap justify-content-between">
                                ...
                                <div className="form-group col-12 col-lg-3 p-0">
                                    <select id="recebimento_uf" className="select_custom form-control" style={{height: '48px'}}>
                                        <option selected disabled>UF</option>
    ...
    10. Não está incluso no valor a taxa de embarque na marina dos pescadores e os passeios de barco em Arraial do Cabo, o valor de R$ 10 será paga no check-in;`} />
                    ...
                    <div id="termos_check" className="custom-control custom-checkbox mt-3">
                ...
                <div className="mt-4 d-flex justify-content-end">
                    ...
                    {/* <button id="btn_prosseguir" className="btn_principal mb-2 col-12 col-md-6 col-lg-4" type="submit">CONFIRMAR PAGAMENTO</button> */}
                </div>
            </form>
        </>
    )
